...
from ..models.SequentialModels import BERT4Rec
from ..metrics import recall_at_k, ndcg_k
from ..data.features import year
...
class Bert4RecTrainer():
    def __init__(self, args, evaluate_data, data_pipeline, runname) -> None:
        ...
        if self.args.model_name in ('BERT',):
            self.model = BERT4Rec(self.num_features, self.cat_features_size, self.args.emb_dim, self.args.mlp_dims, self.args.cross_feature)
        else:
            raise ValueError
